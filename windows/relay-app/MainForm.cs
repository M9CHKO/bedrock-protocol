...
internal sealed class MainForm : Form
{
    ...
    internal MainForm(bool preview = false, RelayBackend? testBackend = null)
    {
        ...
        Text = "CPE Relay — Windows 1.3.11 · Модули";
        ...
        var signature = new Label { Text = "LOCAL RELAY\nWindows x64  /  1.3.11", Dock = DockStyle.Bottom, Height = 52, ForeColor = Theme.Muted, Padding = new Padding(13, 8, 0, 0), Font = new Font("Segoe UI", 9) };
