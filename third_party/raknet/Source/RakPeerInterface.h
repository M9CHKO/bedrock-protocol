...
public:
	...
	/// Override the local GUID before Startup. Used to retain the public
	/// bedrock-protocol-cpp transport option while using RakPeer end-to-end.
	virtual void SetMyGUID(const RakNetGUID guid)=0;
